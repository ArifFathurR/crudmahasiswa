...
<head>
    ...
    <!-- FontAwesome JS-->
    <script defer src="<?= base_url('assets/') ?>assets/plugins/fontawesome/js/all.min.js"></script>


    <!-- App CSS -->
    <link id="theme-style" rel="stylesheet" href="<?= base_url('assets/') ?>assets/css/portal.css">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                    role="button" aria-expanded="false"
                                        alt="<?= $user['nama']?>"><?= $user['nama']?></a>
                                        <img lass="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown"src="<?= base_url('assets/profile/') . $user['gambar'];?>" alt="">
